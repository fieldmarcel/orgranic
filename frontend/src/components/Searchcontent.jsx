...
const Searchcontent = ({id, image, description,rating,title}) => {
  return (
    <div>
 <Link
      to={`/recipe/${id}`}
      className=" sm:h-[24rem] sm:w-[16rem] block sm:mb-5 relative w-full h-96  max-w-xs mx-auto transition-transform duration-300 hover:-translate-y-2"
    >
